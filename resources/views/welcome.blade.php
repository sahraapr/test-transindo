...
<head>
    ...
    <link href="assets/ticket/css/bootstrap.min.css" rel="stylesheet">

    <link href="assets/ticket/css/bootstrap-icons.css" rel="stylesheet">

    <link href="assets/ticket/css/templatemo-festava-live.css" rel="stylesheet">
    ...
    <main>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12 d-flex flex-wrap">
                        <p class="d-flex me-4 mb-0">
                            ...
                            <strong class="text-dark">Welcome to Festival Music</strong>
                        </p>
                    </div>
        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container">
                ...
                <a href="ticket.index.php" class="btn custom-btn d-lg-none ms-auto me-4">Buy Ticket</a>
        ...
        <section class="hero-section" id="section_1">
            ...
            <div class="container d-flex justify-content-center align-items-center">
                <div class="row">
                    ...
                    <div class="col-12 mt-auto mb-5 text-center">
                        <small>Festival Music </small>

                        <h1 class="text-white mb-5">Night Live</h1>
            ...
            <div class="video-wrap">
                <video autoplay="" loop="" muted="" class="custom-video" poster="">
                    <source src="assets/ticket/video/pexels-2022395.mp4" type="video/mp4">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12 mb-4 mb-lg-0 d-flex align-items-center">
                        <div class="services-info">
                            <h2 class="text-white mb-4">About Festival Music</h2>
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="about-text-wrap">
                            <img src="assets/ticket/images/pexels-alexander-suhorucov-6457579.jpg" class="about-image img-fluid">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-5 col-12">
                        <div class="artists-thumb">
                            <div class="artists-image-wrap">
                                <img src="assets/ticket/images/artists/joecalih-UmTZqmMvQcw-unsplash.jpg"
                    ...
                    <div class="col-lg-5 col-12">
                        <div class="artists-thumb">
                            <div class="artists-image-wrap">
                                <img src="assets/ticket/images/artists/abstral-official-bdlMO9z5yco-unsplash.jpg"
                                    class="artists-image img-fluid">
                            </div>
                        ...
                        <div class="artists-thumb">
                            <img src="assets/ticket/images/artists/soundtrap-rAT6FJ6wltE-unsplash.jpg"
                                class="artists-image img-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="pricing-thumb">
                            <div class="d-flex">
                                <div>
                                    <h3><small>Early Bird</small> RP.150.000</h3>
                    ...
                    <div class="col-lg-6 col-12 mt-4 mt-lg-0">
                        <div class="pricing-thumb">
                            <div class="d-flex">
                                <div>
                                    <h3><small>Standard</small> RP.250.000</h3>

                                    <p>What makes a premium Festival Music?</p>
                                </div>
                            </div>
        ...
        <div class="site-footer-top">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <h2 class="text-white mb-lg-0">Festival Music</h2>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-11 mb-4 mb-lg-0 mb-md-0">
                    ...
                    <p class="text-white d-flex mt-3 mb-2">
                        Stadion Utama Gelora Bung Karno</p>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-12 mt-5">
                        <p class="copyright-text">Copyright © Festival Music</p>
                    </div>
...
-->
    ...
    <!-- JAVASCRIPT FILES -->
    <script src="assets/ticket/js/jquery.min.js"></script>
    <script src="assets/ticket/js/bootstrap.min.js"></script>
    <script src="assets/ticket/js/jquery.sticky.js"></script>
    <script src="assets/ticket/js/click-scroll.js"></script>
    <script src="assets/ticket/js/custom.js"></script>
